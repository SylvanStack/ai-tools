...
Revision ID: d60739e795fb
Revises: 
Create Date: 2025-06-29 16:18:40.551159
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['parent_id'], ['auth_dept.id'], ondelete='CASCADE'),
    ...
    op.create_index(op.f('ix_auth_role_role_key'), 'auth_role', ['role_key'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_auth_role_role_key'), table_name='auth_role')
