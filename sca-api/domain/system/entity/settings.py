...
class SystemSettings(BaseModel):
    __tablename__ = "_system_settings"
    ...
    tab_id: Mapped[int] = mapped_column(
        Integer,
        ForeignKey("_system_settings_tab.id", ondelete='CASCADE'),
        comment="关联tab标签"
    )
